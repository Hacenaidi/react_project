...
import { fetchSecteurs, fetchTechniciens, updateTicket } from '../api/Tickets'
...
function Modify() {
  ...
  useEffect(() => {
    if (ticket) {
      setFormData({
        nom: ticket.nomClient,
        prenom: ticket.prenomClient,
        telephone: ticket.numTelClient,
  ...
  const { isLoading: isLoadingUpdate, mutate: doUpdate } = useMutation({
  ...
  const renderStepContent = (step) => {
    switch (step) {
      ...
      case 2:
        ...
        console.log(formData.secteur)
        const selectedSecteur = secteurs.find((e) => e.id == formData.secteur)
        return (
          <div className="step3">
            <div className="resume">
              ...
              <p>
                ...
                {selectedSecteur ? selectedSecteur.sect : formData.secteur}
              </p>
              <p>
    ...
    <div className="index">
      ...
      <main className="content">
        ...
        <div className="steps-action">
          ...
          />
          <Button
            label={activeIndex === items.length - 1 ? 'Modifier' : 'Suivant'}
            icon={
